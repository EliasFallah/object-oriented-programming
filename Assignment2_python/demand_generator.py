...
class DemandGenerator:
    def __init__(self):
        ...
        self.num_demands = random.randint(350, 400)  
    ...
    def new_demand(self, num):
        self.vehicle_id = num
        self.destination_id = random.randint(1, constants.NUM_CITIES - 1)  
        self.capacity_range = random.randint(350, 550)  
        self.remain_range = random.randint(constants.MIN_REMAIN_RANGE, self.capacity_range)  